...
!(function () {
      ...
      e.getTriggerSpecs(t).forEach(function (r) {
        if ("sse:" === r.trigger.slice(0, 4)) {
          var a = function (i) {
            s(u) ||
              (e.bodyContains(t) ||
                n.removeEventListener(r.trigger.slice(4), a),
              htmx.trigger(t, r.trigger, i),
              htmx.trigger(t, "htmx:sseMessage", i));
          };
          ((e.getInternalData(t).sseEventListener = a),
            n.addEventListener(r.trigger.slice(4), a));
        }
      });
    }
  }
    ...
    if (e.getAttributeValue(t, "sse-connect")) {
      ...
      !(function (t, a, i) {
        ...
        ((o.onerror = function (n) {
          ...
          (o.onopen = function (r) {
            if (
              (e.triggerEvent(t, "htmx:sseOpen", { source: o }), i && i > 0)
            ) {
        ...
        u &&
          o.addEventListener(u, function () {
            (e.triggerEvent(t, "htmx:sseClose", { source: o, type: "message" }),
              o.close());
          });
      })(t, i, a);
    }
  ...
  function s(t) {
    if (!e.bodyContains(t)) {
      ...
      if (null != n)
        return (
          e.triggerEvent(t, "htmx:sseClose", {
            source: n,
            type: "nodeMissing",
          }),
          n.close(),
    ...
    onEvent: function (t, n) {
      ...
      switch (t) {
        case "htmx:beforeCleanupElement":
          ...
          return void (
            i &&
            (e.triggerEvent(s, "htmx:sseClose", {
              source: i,
              type: "nodeReplaced",
            }),
